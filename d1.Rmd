...
```{r}
graph_initial$plot_function(X = Approx_Sigma[,1], type = "plotly", interpolate_plot = FALSE)
```
...
```{r}
graph$plot_function(data = "cov", type = "plotly", interpolate_plot = FALSE)
```

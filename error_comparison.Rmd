...
errorRatplot <- ggplot(dat_new, aes(alpha, error, colour = as.factor(m), 
...
myggsave(errorRatplot, width = 12, height = 6)


ggslackr(errorRatplot, 
...
```{r, eval = TRUE, out.width="1200px", out.height="600px", fig.cap = captioner("Covariance error for the tadpole graph.")}
knitr::include_graphics(here::here("data_files/tikzpic/errorRatplot.pdf"))
```
